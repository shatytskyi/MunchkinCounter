...
@Composable
fun DetailsControlsLayoutWithTransition(
    ...
    AdaptiveHeightLayout(
        modifier = modifier,
        items = listOf(
            // Level buttons row with shared transition
            LayoutItem(
                        ...
                        modifier = if (sharedTransitionScope != null && animatedContentScope != null) {
                            with(sharedTransitionScope) {
                                Modifier.sharedBounds(
                                    sharedContentState = rememberSharedContentState(key = "level-controls-$characterId"),
            ...
            // Items row 1: -1/+1 with shared transition
            LayoutItem(
                type = LayoutItemType.DISTRIBUTABLE,
                content = {
                    Box(
                        modifier = if (sharedTransitionScope != null && animatedContentScope != null) {
                            with(sharedTransitionScope) {
                                Modifier.sharedBounds(
                                    sharedContentState = rememberSharedContentState(key = "power-controls-1-$characterId"),
                                    animatedVisibilityScope = animatedContentScope
                                )
                            }
                        } else {
            ...
            // Items row 2: -2/+2 with shared transition
            LayoutItem(
                type = LayoutItemType.DISTRIBUTABLE,
                content = {
                    Box(
                        modifier = if (sharedTransitionScope != null && animatedContentScope != null) {
                            with(sharedTransitionScope) {
                                Modifier.sharedBounds(
                                    sharedContentState = rememberSharedContentState(key = "power-controls-2-$characterId"),
                                    animatedVisibilityScope = animatedContentScope
                                )
                            }
                        } else {
            ...
            // Items row 3: -3/+3 with shared transition
            LayoutItem(
                type = LayoutItemType.DISTRIBUTABLE,
                content = {
                    Box(
                        modifier = if (sharedTransitionScope != null && animatedContentScope != null) {
                            with(sharedTransitionScope) {
                                Modifier.sharedBounds(
                                    sharedContentState = rememberSharedContentState(key = "power-controls-3-$characterId"),
                                    animatedVisibilityScope = animatedContentScope
                                )
                            }
                        } else {
            ...
            // Items row 4: -4/+4 with shared transition
            LayoutItem(
                type = LayoutItemType.DISTRIBUTABLE,
                content = {
                    Box(
                        modifier = if (sharedTransitionScope != null && animatedContentScope != null) {
                            with(sharedTransitionScope) {
                                Modifier.sharedBounds(
                                    sharedContentState = rememberSharedContentState(key = "power-controls-4-$characterId"),
                                    animatedVisibilityScope = animatedContentScope
                                )
                            }
                        } else {
            ...
            // Items row 5: -5/+5 with shared transition
            LayoutItem(
                type = LayoutItemType.DISTRIBUTABLE,
                content = {
                    Box(
                        modifier = if (sharedTransitionScope != null && animatedContentScope != null) {
                            with(sharedTransitionScope) {
                                Modifier.sharedBounds(
                                    sharedContentState = rememberSharedContentState(key = "power-controls-5-$characterId"),
                                    animatedVisibilityScope = animatedContentScope
                                )
                            }
                        } else {
