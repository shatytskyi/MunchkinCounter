...
val MunchkinIcons.Font: ImageVector
    get() {
        if (_Font != null) {
            return _Font!!
        }
        _Font = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF1C274C))) {
                ...
                curveTo(8.414f, 10.5f, 8.75f, 10.164f, 8.75f, 9.75f)
                verticalLineTo(9.222f)
                ...
                curveTo(15.414f, 17.75f, 15.75f, 17.414f, 15.75f, 17f)
                curveTo(15.75f, 16.586f, 15.414f, 16.25f, 15f, 16.25f)
                ...
                curveTo(15.25f, 10.164f, 15.586f, 10.5f, 16f, 10.5f)
