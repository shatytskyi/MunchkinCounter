...
val MunchkinIcons.FontOff: ImageVector
    get() {
        if (_FontOff != null) {
            return _FontOff!!
        }
        _FontOff = ImageVector.Builder(
            name = "FontOff",
            defaultWidth = 800.dp,
            ...
            path(fill = SolidColor(Color(0xFF1C274C))) {
                moveTo(9.952f, 6.25f)
                curveTo(9.522f, 6.25f, 9.12f, 6.25f, 8.792f, 6.299f)
                curveTo(8.421f, 6.354f, 8.04f, 6.485f, 7.735f, 6.824f)
                curveTo(7.441f, 7.151f, 7.337f, 7.541f, 7.292f, 7.913f)
                curveTo(7.25f, 8.261f, 7.25f, 8.692f, 7.25f, 9.18f)
                lineTo(7.25f, 9.222f)
                curveTo(7.25f, 9.636f, 7.586f, 9.972f, 8f, 9.972f)
                curveTo(8.414f, 9.972f, 8.75f, 9.636f, 8.75f, 9.222f)
                curveTo(8.75f, 8.679f, 8.751f, 8.34f, 8.781f, 8.093f)
                curveTo(8.795f, 7.977f, 8.813f, 7.91f, 8.827f, 7.872f)
                curveTo(8.839f, 7.84f, 8.847f, 7.83f, 8.85f, 7.827f)
                lineTo(8.851f, 7.826f)
                curveTo(8.852f, 7.825f, 8.853f, 7.824f, 8.862f, 7.819f)
                curveTo(8.879f, 7.812f, 8.922f, 7.796f, 9.014f, 7.782f)
                curveTo(9.218f, 7.752f, 9.505f, 7.75f, 10f, 7.75f)
                horizontalLineTo(11.25f)
                verticalLineTo(9.5f)
                curveTo(11.25f, 9.914f, 11.586f, 10.25f, 12f, 10.25f)
                curveTo(12.414f, 10.25f, 12.75f, 9.914f, 12.75f, 9.5f)
                verticalLineTo(7.75f)
                horizontalLineTo(14f)
                curveTo(14.495f, 7.75f, 14.782f, 7.752f, 14.986f, 7.782f)
                curveTo(15.078f, 7.796f, 15.121f, 7.812f, 15.138f, 7.819f)
                curveTo(15.147f, 7.824f, 15.148f, 7.825f, 15.149f, 7.826f)
                lineTo(15.15f, 7.827f)
                curveTo(15.153f, 7.83f, 15.161f, 7.84f, 15.173f, 7.872f)
                curveTo(15.187f, 7.91f, 15.205f, 7.977f, 15.219f, 8.093f)
                curveTo(15.249f, 8.34f, 15.25f, 8.679f, 15.25f, 9.222f)
                curveTo(15.25f, 9.636f, 15.586f, 9.972f, 16f, 9.972f)
                curveTo(16.414f, 9.972f, 16.75f, 9.636f, 16.75f, 9.222f)
                lineTo(16.75f, 9.18f)
                curveTo(16.75f, 8.692f, 16.75f, 8.261f, 16.708f, 7.913f)
                curveTo(16.663f, 7.541f, 16.559f, 7.151f, 16.265f, 6.824f)
                curveTo(15.96f, 6.485f, 15.579f, 6.354f, 15.208f, 6.299f)
                curveTo(14.88f, 6.25f, 14.478f, 6.25f, 14.048f, 6.25f)
                horizontalLineTo(9.952f)
                close()
            }
            path(fill = SolidColor(Color(0xFF1C274C))) {
                moveTo(8f, 11.25f)
                curveTo(7.586f, 11.25f, 7.25f, 11.586f, 7.25f, 12f)
                curveTo(7.25f, 12.414f, 7.586f, 12.75f, 8f, 12.75f)
                horizontalLineTo(16f)
                curveTo(16.414f, 12.75f, 16.75f, 12.414f, 16.75f, 12f)
                curveTo(16.75f, 11.586f, 16.414f, 11.25f, 16f, 11.25f)
                horizontalLineTo(8f)
                close()
            }
            path(fill = SolidColor(Color(0xFF1C274C))) {
                moveTo(12.75f, 14.5f)
                curveTo(12.75f, 14.086f, 12.414f, 13.75f, 12f, 13.75f)
                curveTo(11.586f, 13.75f, 11.25f, 14.086f, 11.25f, 14.5f)
                verticalLineTo(16.25f)
                horizontalLineTo(9.5f)
                curveTo(9.086f, 16.25f, 8.75f, 16.586f, 8.75f, 17f)
                curveTo(8.75f, 17.414f, 9.086f, 17.75f, 9.5f, 17.75f)
                horizontalLineTo(14.5f)
                curveTo(14.914f, 17.75f, 15.25f, 17.414f, 15.25f, 17f)
                curveTo(15.25f, 16.586f, 14.914f, 16.25f, 14.5f, 16.25f)
...
private var _FontOff: ImageVector? = null
